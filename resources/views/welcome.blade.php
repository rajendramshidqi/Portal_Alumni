...
.sec-sub { font-size: .95rem; color: var(--ink-soft); line-height: 1.75; }
...
.hero-eyebrow::before {
    ...
    background: rgba(255,255,255,.45); display: block;
}
...
.btn-white:hover { transform: translateY(-2px); box-shadow: 0 10px 32px rgba(0,0,0,.18); color: var(--blue-dark); }
...
.hero-wave { position: relative; z-index: 1; line-height: 0; margin-top: -2px; }
...
/* ══════════════════════════════════════════
   ABOUT
══════════════════════════════════════════ */
.about-section { padding: 96px 0 80px; background: var(--white); }
...
.feature-item { display: flex; align-items: flex-start; gap: 14px; font-size: .92rem; color: var(--ink-soft); line-height: 1.55; }
.fi-icon {
    width: 38px; height: 38px; min-width: 38px;
    background: var(--blue-light); color: var(--blue);
    border-radius: 11px; display: flex; align-items: center; justify-content: center; font-size: .95rem;
}
...
/* ══════════════════════════════════════════
   LOKER
══════════════════════════════════════════ */
.loker-section { padding: 88px 0 96px; background: var(--surface); }
...
.job-card:hover { transform: translateY(-5px); box-shadow: var(--shadow-md); border-color: var(--blue-mid); }

.job-thumb {
    height: 152px; overflow: hidden; background: var(--blue-light);
...
.job-thumb-icon { font-size: 2.4rem; color: var(--blue-mid); }

.job-cat-badge {
    position: absolute; top: 10px; left: 10px;
    font-size: .65rem; font-weight: 700; letter-spacing: .08em; text-transform: uppercase;
    background: rgba(255,255,255,.92); color: var(--blue);
    padding: 4px 10px; border-radius: 99px; border: 1px solid var(--blue-mid);
}

.job-body { padding: 1.1rem 1.2rem; flex: 1; display: flex; flex-direction: column; gap: 5px; }
.job-open { font-size: .7rem; font-weight: 700; color: #22c55e; letter-spacing: .06em; }
.job-title { font-size: .97rem; font-weight: 700; color: var(--ink); line-height: 1.35; }
.job-row { display: flex; align-items: center; gap: 6px; font-size: .8rem; color: var(--ink-soft); }
.job-row i { color: var(--blue); font-size: .8rem; }

.job-foot { padding: .9rem 1.2rem 1.2rem; }
.btn-detail {
    display: block; width: 100%; padding: .7rem; text-align: center;
    border-radius: var(--radius); font-size: .83rem; font-weight: 700;
    background: var(--blue); color: #fff; transition: var(--ease);
}
.btn-detail:hover { background: var(--blue-dark); color: #fff; }
.btn-detail.ghost { background: var(--white); border: 1.5px solid var(--blue); color: var(--blue); }
.btn-detail.ghost:hover { background: var(--blue-light); }
...
.btn-see-all:hover { background: var(--blue); color: #fff; border-color: var(--blue); }
.btn-see-all i { transition: transform var(--ease); }
...
/* ══════════════════════════════════════════
   FORUM
══════════════════════════════════════════ */
.forum-section { padding: 88px 0 96px; background: var(--white); border-top: 1px solid var(--border); }
...
.forum-card:hover { transform: translateY(-5px); box-shadow: var(--shadow-md); border-color: var(--blue-mid); }

.forum-thumb {
    height: 170px; overflow: hidden; background: var(--blue-light);
    display: flex; align-items: center; justify-content: center;
}
.forum-thumb img { width: 100%; height: 100%; object-fit: cover; transition: transform .5s; }
.forum-card:hover .forum-thumb img { transform: scale(1.05); }
.forum-thumb-icon { font-size: 2.6rem; color: var(--blue-mid); }

.forum-body { padding: 1.2rem 1.3rem; flex: 1; display: flex; flex-direction: column; gap: 6px; }
.forum-kat { font-size: .68rem; font-weight: 700; letter-spacing: .1em; text-transform: uppercase; color: var(--blue); }
.forum-title { font-size: .97rem; font-weight: 700; color: var(--ink); line-height: 1.35; }
.forum-author { font-size: .78rem; color: var(--ink-soft); display: flex; align-items: center; gap: 5px; }
.forum-excerpt { font-size: .83rem; color: var(--ink-soft); line-height: 1.65; flex: 1; }

.forum-foot { padding: .9rem 1.3rem 1.3rem; }
.btn-forum {
    display: block; width: 100%; padding: .7rem; text-align: center;
    border-radius: var(--radius); font-size: .83rem; font-weight: 700;
...
.btn-forum:hover { background: var(--blue); color: #fff; }
.btn-forum.muted { border-color: var(--border); color: var(--ink-soft); }
.btn-forum.muted:hover { background: var(--surface); color: var(--ink); }
        ...
        <div class="container hero-inner">
            <div class="row align-items-end g-0">
                ...
                <div class="col-lg-6 pb-5 pb-lg-0" data-aos="fade-up">
                    ...
                    <p class="hero-desc">
                        Tetap terhubung dengan sekolah dan sesama alumni. Temukan peluang karir, forum diskusi, serta komunitas yang terus berkembang.
                    </p>
                    <div class="hero-btns">
        ...
        <div class="container">
            <div class="row align-items-center g-5">
                ...
                <div class="col-lg-7" data-aos="fade-left">
                    ...
                    <p class="sec-sub">
                        Dengan platform ini, diharapkan hubungan antar alumni tetap terjaga dan berkembang dalam lingkungan digital yang dinamis.
                    </p>
    ...
    <section class="loker-section" id="portfolio-section">
        <div class="container">
            ...
            <div class="filter-bar" data-aos="fade-up">
                <button class="filter-pill active" data-filter="*">Semua</button>
                @foreach ($kategoriLoker as $kategori)
                    <button class="filter-pill" data-filter=".kategori-{{ $kategori->id }}">
                        {{ $kategori->nama }}
                    </button>
                @endforeach
            </div>
            ...
            <div class="row g-4">
                ...
                @empty
                    <div class="col-12 text-center py-5" style="color:var(--ink-soft);">
                        <i class="bi bi-inbox" style="font-size:2.2rem;display:block;margin-bottom:10px;opacity:.35;"></i>
    ...
    <section class="forum-section" id="approved-forum-section">
        <div class="container">
            ...
            <div class="row g-4">
                    ...
                    <div class="col-md-6 col-lg-4" data-aos="fade-up">
                        <div class="forum-card">
                            ...
                            <div class="forum-body">
                                <p class="forum-kat"><i class="bi bi-tag-fill me-1"></i>{{ $forum->kategori->nama }}</p>
                ...
                @empty
                    <div class="col-12 text-center py-5" style="color:var(--ink-soft);">
                        <i class="bi bi-chat-square-dots" style="font-size:2.2rem;display:block;margin-bottom:10px;opacity:.35;"></i>
