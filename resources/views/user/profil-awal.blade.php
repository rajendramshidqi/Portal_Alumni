            ...
            <div class="card">
                ...
                <div class="hdr">
                    ...
                    <div class="profile-wrap">
                        ...
                        <label for="foto" class="edit-icon">
                            ✏️
                        </label>
                    </div>
                    ...
                    {{-- FORM UPLOAD --}}
                    <form action="{{ route('alumni.update-foto') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <input type="file" name="foto" id="foto" hidden onchange="previewImg(event)">
                        <button type="submit" class="btn-upload">Simpan Foto</button>
                    </form>
                    ...
                    <form action="{{ route('alumni.update-password') }}" method="POST">
                        ...
                        <div class="frow">
                            <div class="field">
                                ...
                                <input type="password" name="password" id="pw" placeholder="Min. 8 karakter"
                                    minlength="8" required oninput="upd(this.value)">
                                <div class="bars">
